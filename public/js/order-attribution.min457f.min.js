!(function (t) {
  'use strict';
  const e = t.params,
    n = (document.querySelector.bind (document), (t, e) =>
  ...
  (t.getAttributionData = function () {
  ...
  }), t.setOrderTracking (e.allowTracking), 'loading' === document.readyState
    ...
    class extends HTMLElement {
      constructor () {
        if (
          (super (), (this._fieldNames = Object.keys (
            t.fields
      ...
      connectedCallback () {
        ...
        for (const n of this._fieldNames) {
          ...
          (i.type = 'hidden'), (i.name = `${e.prefix}${n}`), (i.value = s (
